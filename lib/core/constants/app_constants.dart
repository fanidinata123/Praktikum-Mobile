...
/// Konstanta global aplikasi D4TI Vokasi
class AppConstants {
  // App Info
  static const String appName = 'Dashboard Mahasiswa D4TI';
  static const String appVersion = '1.0.0';

  // Keys — digunakan untuk SharedPreferences
  static const String userPrefsKey = 'user_prefs';

  // Spacing — ukuran padding/margin konsisten
  static const double paddingSmall = 8.0;
  static const double paddingMedium = 16.0;
  static const double paddingLarge = 24.0;

  // Border Radius — sudut rounded konsisten
  static const double radiusSmall = 8.0;
  static const double radiusMedium = 12.0;
  static const double radiusLarge = 16.0;

  // Dashboard Gradient Colors — warna kartu statistik di dashboard
  ...
  // Individual Gradient Colors (opsional - untuk akses langsung)
